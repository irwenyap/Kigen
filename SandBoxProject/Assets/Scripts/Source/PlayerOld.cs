...
namespace SandBox
{
    public class Player : Entity
    {
        ...
        protected override void OnTriggerEnter(AABBColliderComponent collider)
        {
            Console.WriteLine("Player On trigger enter:");
        }

        protected override void OnTriggerStay(AABBColliderComponent collider)
        {
            //Console.WriteLine($"Charge: {++charge}");
        }

        protected override void OnTriggerExit(AABBColliderComponent collider)
        {
